...
*/
open class RetryOperation<T: Operation>: RepeatedOperation<T> {
    ...
    */
    ...
    open override func operationQueue(_ queue: AdvancedOperationQueue, willFinishOperation operation: Operation, withErrors errors: [Error]) {
