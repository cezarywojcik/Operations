...
open class _OperationProfileLogger<Manager: LogManagerType>: _Logger<Manager>, OperationProfilerReporter {
    ...
    open func finishedProfilingWithResult(_ result: ProfileResult) {
