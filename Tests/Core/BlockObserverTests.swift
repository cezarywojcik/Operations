...
class StartedObserverTests: BaseBlockObserverTests {
    ...
    var called_didAttachToOperation: AdvancedOperation? = .None
    var called_didStartOperation: AdvancedOperation? = .None
...
class CancelledObserverTests: BaseBlockObserverTests {
    ...
    var called_didAttachToOperation: AdvancedOperation? = .None
    var called_didCancelOperation: AdvancedOperation? = .None
...
class ProducedOperationObserverTests: BaseBlockObserverTests {
    ...
    var called_didAttachToOperation: AdvancedOperation? = .None
    var called_didProduceOperation: (AdvancedOperation, NSOperation)? = .None
...
class WillFinishObserverTests: BaseBlockObserverTests {
    ...
    var called_didAttachToOperation: AdvancedOperation? = .None
    var called_willFinish: (AdvancedOperation, [ErrorType])? = .None
...
class DidFinishObserverTests: BaseBlockObserverTests {
    ...
    var called_didAttachToOperation: AdvancedOperation? = .None
    var called_didFinish: (AdvancedOperation, [ErrorType])? = .None
